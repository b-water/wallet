...
CREATE TABLE "Space" (
    ...
    CONSTRAINT "Space_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "Account" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
INSERT INTO "new_Transaction" ("accountId", "amount", "createdAt", "id", "name", "typeId", "updatedAt") SELECT "accountId", "amount", "createdAt", "id", "name", "typeId", "updatedAt" FROM "Transaction";
